...
//   onChange = date => this.setState({ date })
  ...
  const onSubmit = event => {
    ...
    if (!NameValue || !KategoriValue || !WarnaValue || !DetailValue || !TglValue || !LokasiValue || !NamaLengkapValue || !ProdiValue || !JurusanValue  || !EmailValue  || !KontakValue || !AlamatValue || !KeteranganValue|| !Images) {
  ...
  return (
    <div style={{ maxWidth: '700px', margin: '2rem auto' }}>
      <div style={{ textAlign: 'center', marginBottom: '2rem', backgroundColor : '#8F00FF'}}>
        <Title level={2}style={{ color: 'white' }}> KLAIM BARANG</Title>
      </div>
      ...
      <Form onSubmit={onSubmit}>
        ...
        <br />
        <br />
        <label><b>Deskripsi Barang</b></label><br />
        ...
        <br />
        <br />
        <label><b>Waktu dan Lokasi</b></label><br />
        <label>Tanggal Hilang</label><br/>
        <Input placeholder = 'dd/mm/yyyy'onChange={onTglChange} value={TglValue}/>
        <br />
        <br />
        ...
        <br />
        <br />
        <label><b>Profile Anda</b></label><br />
        ...
        <br />
        <br />
        <Button onClick={onSubmit}style={{ color: 'white', backgroundColor: '#8F00FF',margin:'auto' }}> Submit</Button>
      </Form>
    </div>
  );
}
